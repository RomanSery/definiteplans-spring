package com.coderdreams.definiteplans.oauth;
...
import com.coderdreams.definiteplans.oauth.provider.FacebookLogin;
import com.coderdreams.definiteplans.oauth.provider.ISocialProvider;
import com.coderdreams.definiteplans.oauth.util.DpOAuth2User;
...
public class DpOAuth2UserService extends DefaultOAuth2UserService {
    ...
    @Autowired private FacebookLogin fbLogin;
