...
public abstract class MyAbstractRememberMeServices implements RememberMeServices,
    ...
    public final void loginSuccess(HttpServletRequest request,
        ...
        if (!rememberMeRequested(request, parameter, successfulAuthentication)) {
     ...
     * has been requested.
     */
    protected boolean rememberMeRequested(HttpServletRequest request, String parameter, Authentication successfulAuthentication) {
        if (alwaysRemember || successfulAuthentication instanceof OAuth2AuthenticationToken) {
            return true;
        }
